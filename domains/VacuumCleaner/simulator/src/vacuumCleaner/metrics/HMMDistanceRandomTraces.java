 ...
 */
public class HMMDistanceRandomTraces {
    ...
    public static double distance(List<Trace> traces1,
                                  List<Trace> traces2, int nStates, int nTrials, int nIterations) {
...
//        for(List<ObservationInteger> t:lo2) System.out.println(t);
    ...
    //            hmm2 = learner2.iterate();
            ...
            klc.setNbSequences(100);
            klc.setSequencesLength(100);
            double distance1 = klc.distance(hmm1,hmm2);
            double distance2 = klc.distance(hmm2,hmm1);

    //        System.out.println("HMM1:\n" + hmm1);
    //        System.out.println("HMM2:\n" + hmm2);
    //        System.out.println("Distance at trial " + trial + ": " + distance1 + " , " + distance2);

            if (trial==0) {
                distance = (distance1 + distance2)/2;
            } else {
                distance = Math.min(distance, (distance1 + distance2)/2);
            }
        }
        return distance;
    }
